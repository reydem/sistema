                                ...
                                <tr v-for="persona in arrayPersona" :key="persona.id">
                                    <td>
                                       ...
                                       <template v-if="persona.condicion">
                                           <button type="button" class="btn btn-danger btn-ms" @click="desactivarUsuario(persona.id)"> 
                                               <i class="icon-trash"></i>
                                           </button>
                                       </template>
                                       <template v-else>
                                           <button type="button" class="btn btn-info btn-ms" @click="activarUsuario(persona.id)"> 
                            ...
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="direccion" class="form-control" placeholder="Nombre de la persona">
                                    </div>
                                 </div>                               
                                 <div class="form-group row">
                        ...
                        if (result.value) {
                            ...
                            axios.put('./user/desactivar', {
                                'id' : id                            
                                  ...
                                  swalWithBootstrapButtons.fire(
                            'Activado',
                            'El Usuario ha sido actiavo con éxtio.',
                            'success'
                            )
                            }).catch(function (error) {
                                console.log(error);
                        ...
                        if (result.value) {
                            ...
                            axios.put('./user/activar', {
                                'id' : id                            
                                  ...
                                  swalWithBootstrapButtons.fire(
                            'Desactivado',
                            'El usuario ha sido desactiavo con éxtio.',
                            'success'
                            )
                            }).catch(function (error) {
                                console.log(error);
