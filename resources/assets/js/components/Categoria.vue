                                ...
                                <tr v-for="categoria in arrayCategoria" :key="categoria.id">
                                    <td>
                                       ...
                                       <template v-if="categoria.condicion">
                                           <button type="button" class="btn btn-danger btn-ms" @click="desactivarCategoria(categoria.id)"> 
                                               <i class="icon-trash"></i>
                                           </button>
                                       </template>
                                       <template v-else>
                                           <button type="button" class="btn btn-info btn-ms" @click="activarCategoria(categoria.id)"> 
                        ...
                        if (result.value) {
                            ...
                            axios.put('./categoria/desactivar', {
                                'id' : id                            
                                  ...
                                  swalWithBootstrapButtons.fire(
                            'Activado',
                            'Es registro ha sido actiavo con éxtio.',
                            'success'
                            )
                            }).catch(function (error) {
                                console.log(error);
                        ...
                        if (result.value) {
                            ...
                            axios.put('./categoria/activar', {
                                'id' : id                            
                                  ...
                                  swalWithBootstrapButtons.fire(
                            'Desactivado',
                            'Es registro ha sido desactiavo con éxtio.',
                            'success'
                            )
                            }).catch(function (error) {
                                console.log(error);
